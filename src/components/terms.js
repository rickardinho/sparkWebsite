  ...
  <div>
    <div className="Terms">
      ...
      <div className="Terms-body">
        ...
        <P>&nbsp;</P>
        <H4>2. The basics</H4>
        <P>{`2.1 To use the App and make any Purchases, you must be 18 or over. By continuing to use the App and agreeing to these Terms you are representing to us that you are 18 and we can rely on this representation.`}
          <br/><br/>
        ...
        <P>{`3.1 We cannot guarantee the continuous, uninterrupted or error-free operability of the App. There may be times when certain features, parts or content of the App, or the entire App, become unavailable (whether on a scheduled or unscheduled basis) or are modified, suspended or withdrawn by us, in our sole discretion, without notice to you. You agree that we will not be liable to you or to any third party for any unavailability, modification, suspension or withdrawal of the App, or   any features, parts or content of the App.`}
          <br/><br/>
          {`3.2 We may change the format and content of the App from time to time. We reserve the right to modify, change, substitute or withdraw any Events or other information on our App. You agree that your use of the App is on an 'as is' and 'as available' basis and at your sole risk.`}</P>
        <P>&nbsp;</P>
        ...
        <P>&nbsp;</P>
        <H4>5. What you are allowed to do</H4>
        <P>{`5.1 You may only use the App for non-commercial use and only in accordance with these Terms. You may retrieve and display content from the App on a computer or mobile device screen, print and copy individual pages and, subject to the next section, store such pages in electronic form. Additional terms may also apply to certain features, parts or content of the App and, where they apply, they will be displayed before you access the relevant features, parts or content.`}</P>
        <P>&nbsp;</P>
        <H4>6. What you are not allowed to do</H4>
        <P>{`6.1 Except to the extent expressly set out in these Terms, you are not allowed to:`}
          <br/>
        ...
        <P>&nbsp;</P>
        <H4>7. Content &amp; Privacy</H4>
        <P>{`7.1 You retain all your rights to any Content you submit, upload or display on or while using Spark. This means that you own all the Content you post and are responsible for its settings.`}</P>
        <P>&nbsp;</P>
        <P>{`7.2 Content will not show up in public search results on the Site and only Users you have given access will be able view the Content either in your albums or in search results.`}</P>
          <ul>
            <li>
             <ul>
              <li>Although we have created measures to protect your privacy, please be aware this does not mean that only the people you invite will see it. Users may still be able to find a photo or video through other search mechanisms, and then share or link to it outside the Site and/or App.</li>
             </ul>
            </li>
          </ul>
          <ul>
            <li>
             <ul>
              <li>{`Please remember, if you share Content from the Site or provide someone with a direct link to Content, others may be able to see it.`}
              <br/><br/>
              </li>
             </ul>
            </li>
          </ul>
        <P>{`7.3 If you remove your Content from the Site, Spark will promptly hide it from search results on the Site; however, we might still have it stored in backup files or on servers, and we may retain it as needed. We are not responsible for sites that it was shared to before it was removed.`}</P>
        <P>&nbsp;</P>
        <P>{`7.4 By sharing content on Spark, you are also giving other Members on Spark the right to copy, distribute, publicly perform, publicly display, reproduce and create derivative works from it via the Site, third party websites or applications (for example, via services allowing Members to order prints of Content or t-shirts and similar items containing Content, and via social media websites), provided such use is not for a commercial purpose.`}</P>
        <P>&nbsp;</P>
        <P>{`7.5 By uploading, you are confirming that the Content is yours—no one else's—and that the uploading and use of your Content does not violate the privacy rights, publicity rights, copyrights, contract rights, intellectual property rights or human rights of somebody else. If we learn that you are infringing others' rights or are using Content that is not yours, Spark has the right to remove this Content and you agree that you are responsible for any costs associated with the infringement.`}</P>
        <P>&nbsp;</P>
        <P>{`7.6 Spark may manipulate your Content to offer the Spark Services (including transcoding and/or reformatting Content) to allow its use throughout the Spark Services.`}</P>
        <P>&nbsp;</P>
        <P>{`7.7 Spark has the right to place advertising, promotions, notifications or identifiers and watermarks on or near your Content, and how and what are up to us.`}</P>
        <P>&nbsp;</P>
        <P>{`7.8 Spark may moderate Content. However, we are not responsible for what you have uploaded and we are under no obligation to modify or remove any inappropriate Content.`}</P>
        <P>&nbsp;</P>
        <P>{`7.9 If you stop using the Spark Services, your Content may remain on the Site unless you actively remove your Content, and the rights you granted to us and other Users remain.`}</P>
        <P>&nbsp;</P>
        <P>{`7.10 In order to continue to improve the Site and Spark Services, we may use software and other things on the Site that we own or that have been licensed to us ('Spark Software'). Spark has also created the look, feel and architecture of the Site and has posted certain images and videos ('Spark Content'). Together the Spark Content and Spark Software are the 'Spark Materials.' Spark Materials are ours and remain ours. Except in viewing the Site, you agree that you will not copy, distribute, publicly perform, publicly display, reproduce or create derivative works from the Spark Software. If you follow these Terms, you are entitled to use and display the Spark Content the same way you would use other Public Content on the Site.`}</P>
        <P>&nbsp;</P>
        <H4>8. Limits on Use</H4>
        <P>{`8.1 It is a violation of these Terms to disrupt the Site or the way it functions, interfere with other Users' enjoyment of the Site or Spark Services or use the Site to deceive, harass or solicit people.`}</P>
        <P>&nbsp;</P>
        <P>{`8.2 It is also a violation to scrape the Site, fusker files or otherwise make any use of data mining, robots or similar data gathering and extraction tools.`}</P>
        <P>&nbsp;</P>
        <P>{`8.3 It is up to Spark whether to terminate your use for violation of these prohibitions or similar activities.`}</P>
        <P>&nbsp;</P>
        <H4>9. Other Important Guidelines</H4>
        <P>{`9.1 You are solely responsible for your interactions with other Members. Nonetheless, we reserve the right, but are not obligated, to intervene for the benefit of the Site and Spark Services.`}</P>
        <P>&nbsp;</P>
        <P>{`9.2 These Terms and the Privacy Policy can change. Again, please carefully read this document and our other policies. We may announce if any 'big' changes are made, but so long as you've used the Site after the change, regardless of any separate notice, you agree to the current posted version of the Terms.`}</P>
        <P>&nbsp;</P>
        <P>{`9.3 Our Site is hosted in the UK. There may be more or fewer protections for you in your country than here.`}</P>
        <P>&nbsp;</P>
        <P>{`9.4 Software available in connection with the Site and services offered through the Site (the 'Software') is further subject to United Kingdom export controls. No Software may be downloaded from the Spark Services or otherwise exported or re-exported in violation of U.K. export laws. Downloading or using the Software is at your sole risk.`}</P>
        <P>&nbsp;</P>
        <P>{`9.5 These Terms are governed by, and interpreted in keeping with, the laws of the United Kingdom, regardless of any conflict of law provisions. You and Spark agree to submit to the exclusive jurisdiction of the courts located within the United Kingdom to resolve any dispute arising out of the Agreement or the Spark Services.`}</P>
        <P>&nbsp;</P>
        <P>{`9.6 As a Member of Spark, if you become aware of misuse of the Spark Services by any person, please email support@spark-app.net with specific details.`}</P>
        <P>&nbsp;</P>
        <P>{`9.7 You use the Site at your own risk and the Site and services are provided 'AS IS.'`}</P>
        <P>&nbsp;</P>
        <P>{`9.8 We are not saying that the Site will meet any of your specific needs or that you will get any particular results if you use the Site. We are not responsible for the conduct of other Users' conduct on- or off-line.`}</P>
        <P>&nbsp;</P>
        <P>{`9.9 We encourage you to always keep backups of your Content. Spark is not responsible if any of your Content is deleted, or if any modification, suspension or discontinuation of the Site or services causes you to lose any Content—even if you're a Paying Member.`}</P>
        <P>&nbsp;</P>
        ...
        <P>&nbsp;</P>
        <P>{`9.11 We are not responsible for advertisements or applications or services that are posted on or through the Site, nor do we have any responsibility for the goods or services provided by our advertisers or via other websites or applications, including our print vendor.`}</P>
        <P>&nbsp;</P>
        <P>{`9.12 The Site may contain links to other websites, wholly unrelated to Spark. For example, when you seek to print an image, you will be redirected to Spark's print vendor. If you enter the print site, or otherwise click on links to third party sites, you will be leaving the Site. When you do, you will be governed by the terms of use and privacy policy of that other site. You should review that site's terms and policies.`}</P>
        <P>&nbsp;</P>
        ...
        <br/><br/>
        {`15.5 Where videos are displayed they are intended to be purely representative of the artist or event. Your actual experience may vary.`}</P>
        <P>&nbsp;</P>
        <H4>16. Suspension and termination</H4>
        <P>{`16.1 We may suspend or terminate all or part of your use of the App and/or your account if you use (or permit anyone other than you to use) the App or your account in breach of these Terms and we do not reasonably consider that your breach can be resolved, or if it can be resolved you have failed to resolve it to our reasonable satisfaction after we have asked you to do so and given you a reasonable opportunity to do so.`}
        <br/><br/>
        {`16.2 Termination shall not prejudice any other right or remedy you or we may have in respect of accrued rights (including rights in respect of any breach) or liabilities which arose prior to termination.`}</P>
        <P>&nbsp;</P>
        <H4>17. General</H4>
        <P>{`17.1 These Terms are personal to you. You may not transfer or assign any or all of your rights or obligations under these Terms to any other person without our consent.`}
          <br/><br/>
          ...
          <br/><br/>
          {`17.8 These Terms (and all non-contractual relationships between you and us) shall be governed by English law, and you agree that any dispute between you and us regarding them or any Purchase will only be dealt with by the nearest courts in England and Wales (nearest to where you reside).`}</P>
        <P>&nbsp;</P>
        <H4>18. Dispute Resolution</H4>
        <P>{`18.1 In the first instance we request that you Contact Us if you have a complaint against us and we shall try to resolve it.`}</P>
        <P>&nbsp;</P>
        <H4>19. Additional terms relating to Apple</H4>
        <P>{`19.1 If you download, access and/or use the App on Apple’s iOS operating system:`}
          <br/><br/>
        ...
        <P>&nbsp;</P>
        <H4>20. Definitions</H4>
        <P>{`'Merchant' means a third party partner of Spark who sells the events and services for which a Purchase can be made.`}
        <br/><br/>
        ...
        <br/><br/>
        {`'Events' means the events and/or services offered by a particular Merchant for which a Purchase can be made.`}</P>
        <P>&nbsp;</P>
        <H4>21. Contact Us</H4>
        <P>{`Please submit any questions you have about these Terms, an order you have placed or purchasing in general by email to hello@spark-app.net or write to us at:`}
        <br/><br/>
        {`Spark`}
        <br/>
        {`1 Neptune House`}
